...
# from manuever import rover_stuck
from decision import decision_step
from perception import rover_stuck
# from perception import is_rover_stuck
...
class RoverState():
    def __init__(self):
        ...
        self.start_xpos = 0 # record the x coordinates of the starting postion
        self.start_ypos = 0 # record the y coordinates of the starting postion
        self.start_initpos_count = 0 # variable used to only record the initial positions of the rover
        ...
        self.rock_ang = 0 #will be set to angle from rock in perception.py
        self.rock_stop_forward = 70 #stopping distance to stop in front of rock for pickup
        self.a = 0 #variable to test 
        self.c = 0 #variable to limit looping in worldmap update
        self.rock_x_world = 0 #variable to save the xpos rock coordinates
        self.rock_y_world = 0 #variable to save the ypos rock coordinates
        self.rover_x_world = 0 #variable to save the xpos of the rover
        self.rover_y_world = 0 #variable to save the ypos of the rover
        self.rover_x_world_rev = 0 #variable to save the xpos of the rover
        self.rover_y_world_rev = 0 #variable to save the ypos of the rover
        # self.rover_x_pos = np.ones(5, dtype=np.float) #variable to save an array of x coordinates and then perform std deviation to determine if rover is stuck
        # self.rover_y_pos = np.ones(5, dtype=np.float) #variable to save an array of x coordinates and then perform std deviation to determine if rover is stuck
        self.stuck_time = 0 #variable to gather data samples to determine if rover is stuck
        #self.straight_reverse = 'False' #flat that enables the rover to back out straight
        self.reverse = 'False' #flag that enables the rover to turn around
        self.manuever_flag = 'False'    #flag that is used to prevent exessive switch of Rover drive parameters when it is near the rock
        self.turn180 = 'False'
